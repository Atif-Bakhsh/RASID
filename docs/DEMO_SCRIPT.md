...
| 3:15–3:45 | Overspent food budget and an insight's facts | A pure deterministic rule; no AI-generated financial claims |
| 3:45–4:20 | Tests and injected database failure | Rollback is demonstrated with PostgreSQL, not just mocked repository calls |
| 4:20–4:45 | JSON request log and health/readiness | Follow one request ID; alive and ready mean different things |
| 4:45–5:00 | One tradeoff and one independent change | Why no queue/microservices; show a change you made yourself |
